...
<p align="justify">  
  Projeto realizado em Flutter, referente a um PomoDoro(gerenciamento de tempo) utilizando a gerencia de estados GetX - Null Safety.
</p>
...
```
git clone https://github.com/AndersonD-art/PomoDoro_GetX.git
```
---

## 📌 Casos de uso

👍 Projeto inspirado no canal de youtube Cod3r cursos -(https://www.youtube.com/watch?v=LeRjIY4n2Vk).
